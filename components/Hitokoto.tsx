...
export default function Hitokoto() {
  ...
  return (
    <div className="w-full max-w-2xl bg-white/70 border border-black/10 rounded-3xl p-6 md:p-8 backdrop-blur-sm relative group overflow-hidden transition-colors hover:bg-white">
