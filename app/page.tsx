    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300 font-sans selection:bg-cyan-500/30 selection:text-cyan-50 relative">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="font-bold text-white tracking-wider flex items-center gap-2 group">
          ...
          <nav className="flex items-center gap-6 text-sm font-medium">
            <Link href="#blog" className="text-zinc-400 hover:text-white transition-colors">{t.navBlog}</Link>
            <Link href="#projects" className="text-zinc-400 hover:text-white transition-colors">{t.navProjects}</Link>
            <button 
              onClick={toggleLang}
              className="ml-4 w-8 h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-colors"
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 pt-32 pb-24">
        ...
        <section id="projects" className="py-16 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Cyber Match */}
            <Link href="/game" className="group block p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-purple-500/30 transition-all duration-300 md:col-span-2 lg:col-span-1">
              <div className="flex justify-between items-start mb-4">
